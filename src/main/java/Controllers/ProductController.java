...
public class ProductController {
    ...
    public @ResponseBody ResponseObject getProducts() {
        try{
    ...
    public @ResponseBody ResponseObject addProduct(@RequestBody Product product) {
        try{
    ...
    public @ResponseBody ResponseObject getListParts(@RequestParam("productId") Integer productId) {
        try{
    ...
    public @ResponseBody ResponseObject getProduct(@RequestParam("productId") Integer productId) {
        try{
            ...
            return new ResponseObject(false,null,null);
        }catch (Exception e){
            return new ResponseObject(false,e.getMessage(),null);
        }
